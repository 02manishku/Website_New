  ...
  return (
    <>
      <PageHero
        kicker="02 — Wellness"
        title="Wardrobes."
        image="/images/wardrobes/08.jpg"
        subtitle="For the first time ever — wardrobes whose every internal cabinet, door fascia and even handle is made in stone."
      />
      ...
      {/* Wardrobe concepts */}
      <section className="bg-bone py-28 lg:pt-32 pb-32">
          ...
          {WARDROBES.map((w) => (
            <div key={w.name} className="relative overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 p-6 lg:p-8 text-bone bg-gradient-to-t from-ink/70 to-transparent w-full">
                ...
                <div className="font-display text-2xl lg:text-3xl mt-1">{w.finish}</div>
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-px bg-ink/10">
            {[
              ...
              { t: '75 Complimentary Services', c: 'Three complimentary services every year for 25 years — we maintain the excellence of your investment.' }
            ].map((b) => (
...
const WARDROBES = [
  ...
  { name: 'Gallery — Walk-in',          finish: 'Magppie Classico Bianco',  image: '/images/wardrobes/11.jpg' },
  { name: 'Atelier — Dressing room',    finish: 'Magppie Flurry Black',     image: '/images/wardrobes/10.jpg' },
  { name: 'Vestibule — Hallway robe',   finish: 'Magppie Calcatta Perlato', image: '/images/wardrobes/05.jpg' },
  { name: 'Guest — Quiet wardrobe',     finish: 'Magppie Romano',           image: '/images/wardrobes/07.jpg' }
];

const ACCESSORIES = [
  { name: 'Shoe Drawer',          copy: 'Pull-out drawer that brings the back row forward — every pair, easy to reach.' },
  ...
  { name: 'Watch Winder',         copy: 'Compact winder that keeps automatic watches running — fits any shelf.' },
