        ...
        headers: [
          ...
          // (per https://nextjs.org/docs/app/building-your-application/configuring/content-security-policy).
          {
            ...
            value: [
              ...
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.vercel-scripts.com https://va.vercel-scripts.com https://*.sentry.io https://salesiq.zohopublic.in https://*.zohostatic.com https://*.zohocdn.com",
              // SalesIQ injects its own stylesheet at runtime from
              // its static CDN.
              "style-src 'self' 'unsafe-inline' https://*.zohostatic.com https://*.zohocdn.com",
              // Agent avatars, brand assets, chat-message attachments.
              "img-src 'self' data: blob: https://cdn.sanity.io https://*.zohopublic.in https://*.zohostatic.com https://*.zohocdn.com https://*.zoho.in https://*.zoho.com",
              ...
              "connect-src 'self' https://www.zohoapis.in https://accounts.zoho.in https://api.resend.com https://*.vercel-insights.com https://*.sentry.io https://*.zoho.in https://*.zoho.com https://*.zohopublic.in https://*.zohostatic.com https://*.zohocdn.com wss://*.zoho.in wss://*.zoho.com wss://*.zohopublic.in",
